 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class block_whatsapp_plugin extends block_base {

    /**
     * Core function used to initialize the block.
     */
    public function init() {
        $this->title = get_string('pluginname', 'block_whatsapp_plugin');
    }
    ...
    public function get_content() {
        ...
        if (!empty($this->config->activitygradeitemid)) {
            ...
            if (empty($activity)) {
                ...
                $this->content->text = get_string('error_emptyactivityrecord', 'block_whatsapp_plugin');
                return $this->content;
            }
        ...
        if (empty($activitygradeitemid)) {
            $this->content->text = get_string('error_emptyactivityid', 'block_whatsapp_plugin');
            return $this->content;
        }

        // Check to see if we are configured.
        if (empty($this->config->showbest) && empty($this->config->showworst)) {
            $this->content->text = get_string('configuredtoshownothing', 'block_whatsapp_plugin');
            return $this->content;
        }
        ...
        if (empty($activity->gradetype) || ($activity->gradetype != GRADE_TYPE_VALUE && $activity->gradetype != GRADE_TYPE_SCALE)) {
            $this->content->text = get_string('error_unsupportedgradetype', 'block_whatsapp_plugin');
            return $this->content;
        }
        ...
        switch ($groupmode) {
            case VISIBLEGROUPS:
                ...
                if (empty($groups)) {
                    ...
                    $this->content->text = get_string('error_nogroupsexist', 'block_whatsapp_plugin');
                    return $this->content;
                }
                ...
                if (!empty($best)) {
                    ...
                    if ($numbest == 1) {
                        $this->content->text .= get_string('bestgroupgrade', 'block_whatsapp_plugin');
                    } else {
                        $this->content->text .= get_string('bestgroupgrades', 'block_whatsapp_plugin', $numbest);
                    }
                        ...
                        switch ($gradeformat) {
                            case B_ACTIVITYRESULTS_GRADE_FORMAT_SCALE:
                                ...
                                if (isset($scale[$answer])) {
                                    ...
                                    $this->content->text .= get_string('unknown', 'block_whatsapp_plugin');
                                }
                            break;
                ...
                if (!empty($worst)) {
                    ...
                    $this->content->text .= '<table class="grades"><caption class="pb-0"><h6>';
                    if ($numworst == 1) {
                        $this->content->text .= get_string('worstgroupgrade', 'block_whatsapp_plugin');
                    } else {
                        $this->content->text .= get_string('worstgroupgrades', 'block_whatsapp_plugin', $numworst);
                    }
                    $this->content->text .= '</h6></caption><colgroup class="number" />';
                    $this->content->text .= '<colgroup class="name" /><colgroup class="grade" /><tbody>';
            ...
            case NOGROUPS:
                ...
                if (!empty($best)) {
                    $this->content->text .= '<table class="grades"><caption class="pb-0"><h6>';
                    if ($numbest == 1) {
                        $this->content->text .= get_string('bestgrade', 'block_whatsapp_plugin');
                    } else {
                        $this->content->text .= get_string('bestgrades', 'block_whatsapp_plugin', $numbest);
                    }
                    $this->content->text .= '</h6></caption><colgroup class="number" />';
                    $this->content->text .= '<colgroup class="name" /><colgroup class="grade" /><tbody>';
                ...
                if (!empty($worst)) {
                    ...
                    $this->content->text .= '<table class="grades"><caption class="pb-0"><h6>';
                    if ($numbest == 1) {
                        $this->content->text .= get_string('worstgrade', 'block_whatsapp_plugin');
                    } else {
                        $this->content->text .= get_string('worstgrades', 'block_whatsapp_plugin', $numworst);
                    }
                    $this->content->text .= '</h6></caption><colgroup class="number" />';
                    $this->content->text .= '<colgroup class="name" /><colgroup class="grade" /><tbody>';
    ...
    private function activity_format_grade($grade) {
        if (is_null($grade)) {
            return get_string('notyetgraded', 'block_whatsapp_plugin');
        }
    ...
    public function get_config_for_external() {
        ...
        $pluginconfigs = get_config('block_whatsapp_plugin');
